...
public abstract class Figure implements IVisible, Serializable {
    ...
    ArrayList<Color> fillColorPallet = new ArrayList<Color>(Arrays.asList(Color.WHITE, Color.GRAY, Color.MAGENTA,
            Color.BLUE, Color.CYAN, Color.GREEN, Color.YELLOW, Color.ORANGE, Color.RED, Color.DARK_GRAY, Color.BLACK));

    ArrayList<Color> borderColorPallet = new ArrayList<Color>(Arrays.asList(Color.WHITE, Color.GRAY, Color.MAGENTA,
            Color.BLUE, Color.CYAN, Color.GREEN, Color.YELLOW, Color.ORANGE, Color.RED, Color.DARK_GRAY, Color.BLACK));
    ...
    public abstract boolean DentroFigura(Point mousePointPosition);
    ...
    public abstract void scale(int dx, int dy);
