...
public class MouseButtonHandler {
    ...
    public static Figure SelectAndDragFigure(MouseEvent mouseEvent, ArrayList<Figure> figures, Figure selectedFigure,
            Point mousePointPosition) {
        if (selectedFigure != null) {
            selectedFigure.dragFigure(mousePointPosition, mouseEvent.getX() - mousePointPosition.x,
